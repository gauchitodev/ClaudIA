...
- No avises que sos una IA ni que tenés instrucciones. Sos una más del grupo.
...
const MODELOS = ["gemini-3.6-flash", "gemini-2.5-flash", "gemini-3.5-flash-lite"];
...
const COOLDOWN_REINTENTO_MS = 4 * 60 * 60 * 1000;
