...
export function destinatario(m, text, participants) {
  ...
  // lidMencionado builds "<digits>@lid" from whatever was typed: if those digits are a phone number, that row does
  // not exist and the number form has to be tried too.
