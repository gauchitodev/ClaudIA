...
export const secciones = {
  ...
  casino: ["ruleta", "tragamonedas", "slot", "slots", "loteria", "lotería", "boleto", "boletos", "blackjack", "bj", "pedir", "plantarse", "plantarme", "doblar", "dividir", "seguro", "rendirse", "rendirme", "carrera", "caballos", "duelo", "pelea", "acepto", "rechazo", "golpe", "patada", "cubrirse", "curar", "evento", "jugar", "mercados", "mercado", "resolver"],
  ...
  aero: ["metar", "taf", "sigmet", "cruzado", "sol", "menuaero", "aero"],

  extras: ["say", "decir", "sortear", "res", "clima", "tiempo", "traducir", "translate", "horoscopo", "horóscopo", "ig", "rae", "definición", "definicion", "afk", "links", "discord", "faggi", "recordame", "recordar", "recordatorio", "recordatorios", "olvidar", "cumple", "cumples", "cumpleanos", "cumpleaños", "resumen", "quemeperdi", "recap", "recorda", "recordá", "memoria"],
};
