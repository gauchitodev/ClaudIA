...
export const secciones = {
  ...
  casino: ["ruleta", "tragamonedas", "slot", "slots", "loteria", "lotería", "boleto", "boletos"],
  ...
  extras: ["say", "decir", "sortear", "res", "clima", "tiempo", "traducir", "translate", "horoscopo", "horóscopo", "ig", "rae", "definición", "definicion", "afk"],
};
