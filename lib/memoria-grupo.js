// Group memory: things the group itself tells Claudia to remember (".recordá que Fulano siempre llega tarde") and
// that she keeps in mind during conversations, on top of the per-person memory. Anyone can add; whoever added it or
// an admin can delete. Capped per group so the prompt doesn't grow without bound.
...
// Text for Claudia's prompt, or "" when there is nothing.
