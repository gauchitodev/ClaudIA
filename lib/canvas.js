// Composiciones de imagen con jimp 1.x: tarjetas sobre la foto de perfil, bandera circular, stickers de texto,
// cambio de resolución y foto de perfil del bot. Los plugins solo resuelven a quién y qué mandar; todo lo de píxeles
// está acá, así se prueba con imágenes generadas y sin red. Antes cada plugin usaba jimp 0.16 (jimp-legacy) por su cuenta.
...
// Buffer, ruta local o URL. Las URL se bajan con el cliente del core, que aguanta mejor los sitios quisquillosos.
...
// ---------- tarjetas ----------
// Una capa (bandera, sello) sobre la foto, con opacidad y escala; la capa queda centrada. JPEG.
...
// Licencia hot: la foto a un tercio del ancho, apenas rotada, corrida a la izquierda del centro de la tarjeta. JPEG.
...
// La foto recortada en círculo, con la bandera (con transparencias) encima. PNG.
...
// ---------- texto ----------
// Reparte las palabras en líneas parejas: hasta 6 palabras en una grilla cuadrada, más largo con un ancho ideal.
...
// Las líneas centradas en un lienzo transparente de ancho × alto, escaladas para que entren con margen.
...
// Cuadros del sticker RGB: el mismo texto, cada cuadro de un color del arcoíris. PNG cada uno.
...
// Foto de perfil para subir: escalada para que el lado mayor mida "lado". JPEG.
