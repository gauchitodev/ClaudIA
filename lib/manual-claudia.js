...
- .metar [ICAO o nombre, ej. SULS o punta]: METAR de un aeródromo decodificado en español (sin nada, Carrasco); .taf el pronóstico TAF; .sigmet los avisos vigentes de la FIR Montevideo (tormentas, turbulencia, engelamiento, ceniza); .cruzado 06 190 19 calcula viento cruzado y de frente para una pista con un viento dado; .reciproco 045 (o .reciproco 06L) el rumbo o la pista recíprocos; .sol [ciudad] la salida y puesta del sol y el crepúsculo civil; .zulu la hora Zulu, la de Uruguay y las 25 zonas horarias con su letra militar; .dtg lo mismo en formato DTG (061532Z SEP 26); .menuaero explica y lista los nombres que entiende. Datos de la NOAA, horas en UTC salvo .sol, que va en hora local del lugar.
