...
export const PAREJAS = {
  ...
  DIAS_PARA_CASARSE: 7,
  ENOJO_MS: 60 * 60 * 1000, // cuánto dura el enojo por un intento de infidelidad
  ABANDONO_DIAS: 3, // días sin beso ni regalo para que el próximo beso pueda ser rechazado
...
// ---- besos, enojos y reconciliaciones ----

// Alguien con pareja intentó besar a otra persona: su pareja queda enojada un rato. Devuelve el lid de la pareja.
...
// El enojo vigente de la pareja de `lid` contra `lid`, o null.
...
// Un regalo a la pareja: si estaba enojada se le pasa, y cuenta como atención (como un beso). Devuelve true si había enojo.
...
// Un beso entre pareja. Devuelve null si no son pareja; si no, { tipo: "enojo" | "abandono" | "ok", ... }.
// Con enojo vigente se rechaza siempre; tras días sin beso ni regalo, el primero puede ser rechazado una vez.
