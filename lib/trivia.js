...
export const TRIVIA = {
  ...
  RESERVA_MS: 60 * 1000, // cuánto puede tardar en armarse una ronda antes de soltar el turno
};
...
// Reserva el turno del chat mientras se genera la pregunta (la IA tarda), para que no se abran dos trivias a la vez.
// Devuelve false si ya hay una ronda o una reserva. La reserva se suelta sola si el que la pidió nunca abre la ronda.
...
export function abrirRonda(chat, { tipo, pregunta, mensajeId, segundos, client, alGanar = null, alVencer = null }) {
  liberarRonda(chat); // la reserva, si la había, la ocupa esta ronda
