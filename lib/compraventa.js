...
export function detectarPrecio(texto) {
  ...
  // El punto y la coma del final son de la oración, no del número: "silla, $ 500, Pocitos" da "$ 500", no "$ 500,".
...
// El anuncio de una publicación nueva, igual para los dos caminos (#vendo suelto y .vendo). Guarda el id del mensaje
// de confirmación: citándolo se puede cerrar la publicación después, sin acordarse del número.
