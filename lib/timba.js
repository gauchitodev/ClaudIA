...
export const JUEGOS = [
  { clave: "ruleta", nombre: "Ruleta", emoji: "🎰", apuesta: ["casino_ruleta"], cobro: ["casino_ruleta_premio", "escudo_ruleta"] },
  { clave: "tragamonedas", nombre: "Tragamonedas", emoji: "🎰", apuesta: ["casino_tragamonedas"], cobro: ["casino_tragamonedas_premio", "escudo_tragamonedas"] },
  {
    ...
    cobro: ["casino_blackjack_premio", "casino_blackjack_empate", "casino_blackjack_rendicion", "casino_blackjack_seguro_premio", "escudo_blackjack"],
  },
  ...
  { clave: "carrera", nombre: "Carrera", emoji: "🐎", apuesta: ["casino_carrera"], cobro: ["casino_carrera_premio", "escudo_carrera"] },
  ...
  { clave: "juegos", nombre: "Apuestas en juegos", emoji: "🎯", apuestaPrefijo: ["apuesta_"], cobro: ["apuesta_ganada", "escudo_apuesta"] },
];
