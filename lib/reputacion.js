...
// ---------- corrección por admins (calificaciones maliciosas) ----------
// La reputación es global, pero cada calificación se hizo en un grupo: la puede tocar un admin de ese grupo, el
// owner, o quien la hizo (solo borrarla).
