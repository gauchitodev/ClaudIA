...
export const ACTIVIDAD = {
  ...
  RELAMPAGO_VECES: 2, // tope de trivias relámpago por día
  RELAMPAGO_PROBABILIDAD: 0.45, // chance de que cada una se agende (con 2 y 0,45 salen ~0,9 por día)
  RELAMPAGO_MENSAJES_MINIMOS: 40, // mensajes del día anterior que tiene que tener el grupo para que se agende
...
export function registrarActividad(chat, usuario, texto) {
  ...
  // con la economía apagada (.monedas / .modo compraventa) la racha se cuenta igual, pero no paga
...
// Línea para .racha. "" si nunca tuvo racha.
