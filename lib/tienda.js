...
import { gastarCoins, getSaldoCoins, getItem, getInventario, agregarItem, consumirItem, borrarItem, updateUser } from "../database-functions.js";
...
export const ITEMS = {
  escudo: {
    ...
    precio: 25,
    max: 1,
    desc: "Si perdés una apuesta, te devuelve lo apostado. Se usa solo, una vez.",
  },
  racha: {
    nombre: "Racha doble",
    emoji: "🔥",
...
// resumen corto de lo que tiene una persona (para .inventario y .coins). "" si no tiene nada.
