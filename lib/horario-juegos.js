...
export function horarioDe(chat) {
  const guardado = chat?.horarioJuegos;
...
export function fijarHorario(chat, texto) {
  ...
  return { ok: true, horario: h, mensaje: `🕒 Listo: los juegos en este grupo van ${textoHorario(h)}. Fuera de ese horario no andan. Con .horariojuegos off se saca.` };
}
