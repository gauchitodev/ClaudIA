// Cumpleaños del grupo: cada uno anota el suyo con .cumple 14/03 y ese día, a partir de las 9, Claudia lo saluda
// y lo menciona en el grupo donde se anotó. Sin monedas ni premios. El chequeo corre cada 5 minutos desde
// tareas-programadas.js y queda registrado para no saludar dos veces el mismo día.
...
// días que faltan para el próximo cumpleaños con ese día y mes (0 = es hoy)
...
async function saludoPara(usuario) {
  ...
  let texto = fijos[Math.floor(Math.random() * fijos.length)];
