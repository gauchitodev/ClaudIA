...
export const COINS = {
  ...
  SALTAR_COOLDOWN: 15,
  APUESTA_MIN: 5,
  // Máximo por apuesta: el tope fijo de cada juego, o este porcentaje del saldo de la persona, lo que sea mayor.
...
// Máximo que puede apostar una persona: el tope fijo del juego, o el porcentaje de su saldo, lo que sea mayor.
