...
import { textoCruzado, textoReciproco } from "../lib/aero-calculos.js";
import { textoReloj, textoDtg } from "../lib/aero-reloj.js";

const plugin = {};
plugin.cmd = ["metar", "taf", "sigmet", "cruzado", "reciproco", "recíproco", "opuesto", "sol", "zulu", "reloj", "utc", "dtg", "menuaero", "aero"];

// .metar [ICAO o nombre ...] · .taf [ICAO o nombre ...] · .sigmet · .cruzado <pista> <viento> · .reciproco <rumbo o pista> · .sol [ciudad] · .zulu · .dtg · .menuaero
