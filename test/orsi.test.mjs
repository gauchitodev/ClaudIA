...
test(".orsi contesta con una de sus frases, y con el tiempo salen todas", async () => {
  ...
  assert.equal(vistas.size, FRASES.length, "en 300 tiradas tienen que salir las trece");
});
